...
def line_plot(data: dict) -> None:
    ...
    for name, d in list(data.items()):
        ...
        ci_lower3, ci_upper3 = _compute_ci(d[0])
        ci_lower4, ci_upper4 = _compute_ci(d[1])
        ...
        if task_name == "cybench":
            ...
            cybench3.plot(x, d[0], f"{colour[0]}o-", label=model_name)
            ...
            intercode3.plot(x, d[0], f"{colour[0]}o-", label=model_name)
            intercode3.fill_between(x, ci_lower3, ci_upper3, color=f"light{colour[1]}")

            intercode4.plot(x, d[1], f"{colour[0]}o-", label=model_name)
    ...
    cybench3.set_xlabel("Epochs")
    intercode3.set_xlabel("Epochs")
    cybench4.set_xlabel("Epochs")
    intercode4.set_xlabel("Epochs")

    cybench1.set_ylabel("Success rate")
    intercode1.set_ylabel("Success rate")
    cybench2.set_ylabel("Standard deviation")
    intercode2.set_ylabel("Standard deviation")
    cybench3.set_ylabel("Success rate")
    intercode3.set_ylabel("Success rate")
    cybench4.set_ylabel("Standard deviation")
    intercode4.set_ylabel("Standard deviation")
